...
public:
  ...
  typedef btree_multiset<key_type, key_compare, traits, allocator_type>
      self_type;

  /// Implementation type of the btree_base
  typedef stx::btree<key_type, data_type, value_type, key_compare, traits, true,
                     allocator_type, true>
      btree_impl;
...
public:
  ...
  /// copy of all keys.
  inline btree_multiset(const btree_multiset &other) : tree(other.tree) {}

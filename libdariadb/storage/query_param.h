...
struct QueryInterval : public QueryParam {
  ...
  QueryInterval(Time _from, Time _to) : QueryParam(), from(_from), to(_to) {}
...
struct QueryTimePoint : public QueryParam {
  ...
  QueryTimePoint(Time _time_point) : QueryParam(), time_point(_time_point) {}

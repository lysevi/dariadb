...
int main(int argc, char *argv[]) {
  ...
  //  {
  //    std::unique_ptr<RectangleMethod> p{new
  //    RectangleMethod(RectangleMethod::Kind::LEFT)};
  ...
  //  {
  //    std::unique_ptr<RectangleMethod> p{new
  //    RectangleMethod(RectangleMethod::Kind::RIGHT)};
  ...
  //  {
  //    std::unique_ptr<RectangleMethod> p{new
  //    RectangleMethod(RectangleMethod::Kind::MIDLE)};
